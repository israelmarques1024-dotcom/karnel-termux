...
_karnel_completions() {
  ...
  local commands="backup brain cleanup doctor env help ia init install list open pg reinstall restore robin search show start status uninstall update upgrade version voice"
