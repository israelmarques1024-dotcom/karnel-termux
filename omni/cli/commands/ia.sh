...
ia_routes() {
	...
	for cmd in qwen gemini claude vibe openclaude openclaw ollama codex opencode mimo engram codegraph pi agy mmx gentle-ai gga hermes kimi command-code freebuff kilocode cline crush odysseus kimchi omni-route ctx7 openspec; do
