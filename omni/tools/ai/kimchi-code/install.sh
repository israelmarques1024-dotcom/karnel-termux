...
# Kimchi CLI - Omni installer
# Usa o sistema de import padronizado do Omni (bootstrap.sh)
import "@/utils/log"
import "@/utils/colors"
...
KIMCHI_DATA_DIR="$HOME/.local/share/omni-data/kimchi"
...
_install_kimchi_wrapper_impl() {
  ...
  # O caminho e resolvido no momento da instalacao (KIMCHI_BIN_PATH = $HOME/.local/share/omni-data/kimchi/kimchi).
  cat > "$wrapper_path" << WRAPPER
#!/data/data/com.termux/files/usr/bin/bash
# Kimchi CLI wrapper — gerado pelo Omni
